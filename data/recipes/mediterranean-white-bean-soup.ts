...
const recipe: Recipe = {
  ...
  "products": [
    ...
    "and-cook-for-an-additional-2-3-minutes-add-vegetable-broth-and-beans",
    "and-serve-with-artisan-bread",
    "bring-to-a-boil",
    "celery",
    "chopped-for-serving-in-a-large-pot",
    "chopped-1-celery-rib",
    "chopped-2-garlic-cloves",
    "chopped-6-cups-vegetable-broth-1-tsp-dried-thyme-1-2-tsp-oregano-1-tsp-sea-salt-1-2-tsp-black-pepper-3-15-oz-cans-white-beans",
    "chopped-parmesan-cheese",
    "drained-and-rinsed-2-cups-baby-spinach",
    "grated-for-serving-parsley",
    "heat-bh-garlic-olive-oil-over-medium-high-heat-add-onions-and-garlic-cook-about-2-3-minutes",
    "if-desired",
    "mediterranean-white-bean-soup-1-tbs-bh-garlic-olive-oil-1-large-onion",
    "minced-1-large-carrot",
    "oregano",
    "reduce-heat-and-simmer-for-15-minutes-stir-in-the-spinach-and-continue-to-simmer-until-the-spinach-wilts",
    "salt-and-pepper",
    "sprinkle-fresh-parsley-and-grated-parmesan-cheese",
    "stirring-regularly-add-in-the-carrots",
    "thyme"
  ]
}
