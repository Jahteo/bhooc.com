...
const recipe: Recipe = {
  "slug": "salmon-spinach-frittata",
  "name": "Salmon Spinach Frittata",
  "img": "",
  "ingredients": [
    "1 red onion, chopped",
  ...
  "description": "Big Horn Olive Oil Company's Salmon Spinach Frittata recipe will knock your socks off! Serve hot or chill to eat as an appetizer. Basil olive oil is a must!",
  "categories": [],
  "products": [
    "basil-olive-oil",
    "frittata",
