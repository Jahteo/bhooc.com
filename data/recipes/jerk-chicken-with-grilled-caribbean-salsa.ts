...
const recipe: Recipe = {
  "slug": "jerk-chicken-with-grilled-caribbean-salsa",
  "name": "Jerk Chicken with Grilled Caribbean Salsa",
  "img": "",
  "ingredients": [
    "Sauce Ingredients:",
  ...
  "description": "Jazz up summer with Jerk chicken with grilled caribbean salsa. Cilantro roasted onion olive oil paired with pineapple balsamic vinegar makes this dish pop!",
  "categories": [],
  "products": [
