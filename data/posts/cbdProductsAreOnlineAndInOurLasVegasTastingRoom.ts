...
const post: Post = {
  ...
  "description": "Buy while we still have product. CBD has been so popular, and we're sad to see it go. Use your oils quickly. Vinegars will stick around for three years.",
  "categories": [
    "news",
    "uncategorized"
  ],
