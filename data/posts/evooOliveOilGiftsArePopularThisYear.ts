...
const post: Post = {
  "slug": "evoo-olive-oil-gifts-are-popular-this-year",
  "name": "EVOO olive oil gifts are popular this year",
  "img": "",
  "ingredients": [],
  "steps": [
  ...
  "description": "EVOO olive oil gift sets are hitting the shelves just in time for all your hard-to-buy-for loved ones, and you can taste everything before you buy!",
  "categories": [
    "uncategorized"
  ],
  "products": [
