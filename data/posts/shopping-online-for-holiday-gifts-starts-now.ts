...
const recipe: Recipe = {
  "slug": "shopping-online-for-holiday-gifts-starts-now",
  "name": "Shopping online for holiday gifts starts now",
  "img": "",
  "ingredients": [],
  "steps": [
  ...
  "description": "Shopping online has made holiday gifts a cinch. BHOOC.com is open for all your holiday shopping. Send sets or create your own. Wow your friends and family!",
  "categories": [
    "uncategorized"
  ],
  "products": [
    "balsamic-vinegar-gifts",
    "holiday-gifts",
    "holiday-shopping",
    "oil-and-vinegar-gift",
    "olive-oil-gifts",
    "online-gifts",
    "shopping-online"
  ]
