...
const post: Post = {
  ...
  "name": "Aged balsamic vinegar is a coveted Italian treat",
  "img": "",
  "ingredients": [],
  "steps": [
  ...
  "description": "Drizzling aged balsamic vinegar over bread, meats and cheeses has been an Italian tradition for centuries. BHOOC.com carries 18 year-old balsamic vinegar.",
  "categories": [
    "uncategorized"
  ],
  "products": [
