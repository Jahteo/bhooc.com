...
const post: Post = {
  "slug": "what-is-the-best-olive-oil-for-cooking",
  "name": "What is the best olive oil for cooking?",
  "img": "",
  "ingredients": [],
  "steps": [
  ...
  "description": "The best olive oil for cooking must come from fresh olives that are picked green off the tree. Olive Oil Company carries fresh, unadulterated oil.",
  "categories": [
    "uncategorized"
  ],
  "products": [
