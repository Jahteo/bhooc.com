...
const post: Post = {
  "slug": "grocery-store-for-olive-oil-well-yes",
  "name": "Grocery store for olive oil? Well, yes!",
  "img": "",
  "ingredients": [],
  "steps": [
  ...
  "description": "Finding an olive oil grocery store with quality product is tough, unless you know where to shop. Olive Oil Company offers the best options around!",
  "categories": [
    "uncategorized"
  ],
  "products": [
